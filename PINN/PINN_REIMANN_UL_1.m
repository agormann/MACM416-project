% PINN FOR INVISCID BURGERS (u0 = {1 if x < 0, 0 if x > 0})
...
u0BC1 = ones(1, numBoundaryConditionPoints(1));         % left = 1
u0BC2 = zeros(1, numBoundaryConditionPoints(2));        % right = 0
...
u0IC = double(x0IC < 0);                             % Initial condition: 1 for x < 0, 0 otherwise
...
% video stuff
videoFileName = 'reimannMovie.mp4';
